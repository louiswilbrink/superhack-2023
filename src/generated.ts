// Generated by @wagmi/cli@1.3.0 on 8/9/2023 at 10:15:28 AM
import {
  useNetwork,
  useContractRead,
...
export const journalABI = [
  {
    ...
    type: 'function',
    inputs: [
      { name: '_timestamp', internalType: 'string', type: 'string' },
  ...
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: '_timestamp', internalType: 'string', type: 'string' }],
    name: 'deleteEntryByTimestamp',
    outputs: [],
  },
  {
    stateMutability: 'view',
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link journalABI}__.
 */
export function useJournalRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof journalABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof journalABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({
    abi: journalABI,
    ...config,
  } as UseContractReadConfig<typeof journalABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"getEntry"`.
 */
export function useJournalGetEntry<
  TFunctionName extends 'getEntry',
  TSelectData = ReadContractResult<typeof journalABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof journalABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"getEntryLength"`.
 */
export function useJournalGetEntryLength<
  TFunctionName extends 'getEntryLength',
  TSelectData = ReadContractResult<typeof journalABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof journalABI, TFunctionName, TSelectData>,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link journalABI}__.
 */
export function useJournalWrite<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof journalABI, string>['request']['abi'],
        TFunctionName,
        TMode
      >
    : UseContractWriteConfig<typeof journalABI, TFunctionName, TMode> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<typeof journalABI, TFunctionName, TMode>({
    abi: journalABI,
    ...config,
  } as any)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"addEntry"`.
 */
export function useJournalAddEntry<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof journalABI,
    ...
    : UseContractWriteConfig<typeof journalABI, 'addEntry', TMode> & {
        abi?: never
        functionName?: 'addEntry'
      } = {} as any,
) {
  return useContractWrite<typeof journalABI, 'addEntry', TMode>({
    abi: journalABI,
    functionName: 'addEntry',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"deleteEntryByTimestamp"`.
 */
export function useJournalDeleteEntryByTimestamp<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'deleteEntryByTimestamp',
        TMode
      > & { functionName?: 'deleteEntryByTimestamp' }
    : UseContractWriteConfig<
        typeof journalABI,
        'deleteEntryByTimestamp',
        TMode
  ...
  return useContractWrite<typeof journalABI, 'deleteEntryByTimestamp', TMode>({
    abi: journalABI,
    functionName: 'deleteEntryByTimestamp',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link journalABI}__.
 */
export function usePrepareJournalWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof journalABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({
    abi: journalABI,
    ...config,
  } as UsePrepareContractWriteConfig<typeof journalABI, TFunctionName>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"addEntry"`.
 */
export function usePrepareJournalAddEntry(
  config: Omit<
    UsePrepareContractWriteConfig<typeof journalABI, 'addEntry'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'addEntry',
    ...config,
  } as UsePrepareContractWriteConfig<typeof journalABI, 'addEntry'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link journalABI}__ and `functionName` set to `"deleteEntryByTimestamp"`.
 */
export function usePrepareJournalDeleteEntryByTimestamp(
  config: Omit<
    UsePrepareContractWriteConfig<typeof journalABI, 'deleteEntryByTimestamp'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
